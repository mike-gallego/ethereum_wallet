                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Text(
                          BlocProvider.of<TimelineBloc>(context).state.index == 4
                              ? 'Your transaction has completed!'
                              : BlocProvider.of<TimelineBloc>(context).state.index == 1 ? 'Your transaction is processing!' : 'Your transaction has started!',
                    ...
                    Padding(
                      ...
                      child: NeumorphicButton(
                        onPressed: () {
                          BlocProvider.of<TransactionBloc>(context).add(ResetHash());
                          BlocProvider.of<PageBloc>(context).add(SwitchPage(pageID: 'Wallet'));
